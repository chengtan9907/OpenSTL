...
class PhyDNet_Model(nn.Module):
    def __init__(self, pre_seq_length, aft_seq_length, device, **kwargs):
        ...
        self.phycell = PhyCell(input_shape=(16,16), input_dim=64, F_hidden_dims=[49], n_layers=1, kernel_size=(7,7), device=device) 
        self.convcell = PhyD_ConvLSTM(input_shape=(16,16), input_dim=64, hidden_dims=[128,128,64], n_layers=3, kernel_size=(3,3), device=device)   
